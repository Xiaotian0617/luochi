    ...
    <div class="d-wrap ub">
      <div id="dLeft" class="ub-f1 ub ub-ver">
        <el-card shadow="hover">
          <details-chart-of-k-line
            class="ub-f1"
            :W="leftChartStyle.W"
            :H="leftChartStyle.H * 0.8"
            :period="period"
            :title="data && data.equipmentName"
            :data="kLineData"
            @switchKlineType="switchKlineType"
          ></details-chart-of-k-line>
        </el-card>
      ...
      <el-card id="dRight" shadow="hover" class="i-card">
        <a
          :href="'#/index/detail?deviceName=' + deviceName"
          class
          style="display:block;padding: 20px;"
        >
          <p v-if="data" class="f25 fb m5_0">{{data.equipmentName || ' '}}</p>
          <div class="d-img">
            <img v-if="data" :src="'http://pc.lebg.net/img/' + data.sort + '.jpg'">
          </div>
